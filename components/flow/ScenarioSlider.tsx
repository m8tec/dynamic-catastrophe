...
export default function ScenarioSidebar({ data, isDynamic }: ScenarioSidebarProps) {
          ...
          {data.teaserImage ? (
            <div className="relative w-full h-48 shrink-0">
              ...
              <div 
                ...
                style={{ background: `linear-gradient(to bottom, transparent 0%, ${sidebarBg} 100%)` }}
              />
            </div>
          ) : (
          ...
          <div className="px-6 pb-6 flex flex-col gap-6 -mt-2 relative z-10">
            ...
            <div>
              <h2
                ...
                style={{ color: theme.nodeTextActive, fontFamily: TYPOGRAPHY.nodeFontFamily }}
              >
                {data.title}
              </h2>
            ...
            {isDynamic && data.prompt && (
              <div 
                ...
                style={{ borderColor: theme.nodeBorderInactive, backgroundColor: theme.nodeBackgroundUndiscovered }}
              >

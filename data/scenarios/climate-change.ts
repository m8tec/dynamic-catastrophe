...
export const nodes: StaticNode[] = [
  ...
  { id: '3', type: 'option', data: { label: 'Ich versuche, nicht daran zu denken' } },
  { id: '4', type: 'circle', data: { label: 'Verdrängst du da vielleicht etwas?' } },
  ...
  { id: '9', type: 'option', data: { label: 'Ich mag deine Lösungen nicht, also sind sie falsch' } },
  { id: '10', type: 'option', data: { label: 'Ändert sich das Klima nicht eh dauernd?' } },
  { id: '11', type: 'option', data: { label: 'Gott wird eingreifen bevor es zu schlimm wird' } },


  { id: '12', type: 'option', data: { label: 'Ja' } },
  { id: '13', type: 'diamond', data: { label: 'Sind wir am Arsch?' } },
  { id: '14', type: 'option', data: { label: 'Ich versuche, nicht daran zu denken' } },
  { id: '15', type: 'option', data: { label: 'Wen meinst du mit »wir«?' } },
  { id: '16', type: 'curved', data: { label: 'Meine Freund*innen und ich fliehen in ein skandinavisches Landhaus.' } },
  { id: '17', type: 'option', data: { label: 'Denn…' } },
  { id: '18', type: 'option', data: { label: 'Die Apokalypse wird Anderen passieren' } },
  { id: '19', type: 'circle', data: { label: 'Könnte es sein, dass du Gefühle verdrängst?' } },
  { id: '20', type: 'option', data: { label: '...oder ein wenig rassistisch bist?' } },
  ...
  { id: '25', type: 'option', data: { label: '…ohne dich zu sehr als Besserwisser zu inszenieren' } },
  { id: '26', type: 'diamond', data: { label: 'Es betrifft uns also alle gleichermaßen?' } },
  { id: '27', type: 'option', data: { label: 'NEIN!' } },
  { id: '28', type: 'border', data: { label: 'Menschen, die die Auswirkungen des Klimawandels als erste und am schlimmsten erleben, werden auf Englisch »Frontline Communities« genannt. Sie sind überwiegend Niedrigverdienende, People of Color, Indigene, aus dem globalen Süden, oder sie arbeiten unter gesundheitsschädlichen Bedingungen.' } },
  { id: '29', type: 'option', data: { label: 'Wem?!' } },
  { id: '30', type: 'option', data: { label: 'Ohne uns keine Beschlüsse über uns' } },
  { id: '31', type: 'option', data: { label: 'Sozusagen…' } },
  { id: '32', type: 'option', data: { label: 'Selber Sturm, unterschiedliche Boote' } },
  { id: '33', type: 'option', data: { label: 'Also…' } },
  { id: '34', type: 'diamond', data: { label: 'Können wir das wieder reparieren?' } },
  { id: '35', type: 'option', data: { label: 'Ich versuche, nicht daran zu denken' } },
  ...
  { id: '45', type: 'border', data: { label: 'Ein Komplexes Problem (engl. »wicked problem«) kannst du nicht definieren, geht nie vorbei, hat keine korrekte Antwort (z.B. gibt es keine optimale Lösung, auf die man sich einigen kann), ist einzigartig (z.B. so besonders, dass kein früheres Problem als Modell dienen kann) und ist selbst das Symptom von anderen (komplexen) Problemen.' } },
  { id: '46', type: 'option', data: { label: 'Oh, aber der Klimawandel ist sogar noch schlimmer' } },
  { id: '47', type: 'option', data: { label: 'Weil…' } },
  { id: '48', type: 'option', data: { label: '…diejenigen, die das Problem lösen wollen, zugleich die sind, die es verursachen!' } },
  { id: '49', type: 'option', data: { label: 'Und die Zeit wird knapp!' } },
  { id: '50', type: 'option', data: { label: 'Weshalb der Klimawandel ein »Superkomplexes Problem« ist' } },
  { id: '51', type: 'option', data: { label: 'Weshalb wir es zu tun haben mit einem…' } },
  { id: '52', type: 'rectangle', data: { label: 'Dilemma, nicht Problem' } },
  { id: '53', type: 'option', data: { label: 'Ein gewöhnliches Problem' } },
  { id: '54', type: 'quote', data: { label: 'Es ist ein technisches Problem, für das es technische Lösungen gibt. — Rex Tillerson' } },
  { id: '55', type: 'option', data: { label: 'Kommt darauf an…' } },

  { id: '56', type: 'diamond', data: { label: 'In welcher Art Krise stecken wir?' } },
  { id: '57', type: 'option', data: { label: 'Ich versuche, nicht daran zu denken' } },
  ...
  { id: '73', type: 'cloud', data: { label: 'Unsere ökologische Krise ist das Ergebnis vieler Krisen.' } },
  ...
  { id: '79', type: 'option', data: { label: 'Ich versuche, nicht daran zu denken' } },
  ...
  { id: '85', type: 'rectangle', data: { label: 'Zusammenbruch der Zivilisation' } },
  { id: '86', type: 'option', data: { label: 'Richtig richtig schlimm' } },
  { id: '87', type: 'diamond', data: { label: 'Soll ich anderen sagen wie schlimm?' } },
  { id: '88', type: 'option', data: { label: 'Nein' } },
  { id: '89', type: 'option', data: { label: 'Ja' } },
  { id: '90', type: 'rectangle', data: { label: 'Das Aussterben der Menschheit' } },
  { id: '91', type: 'option', data: { label: 'Neeeiiinnn!' } },
  { id: '92', type: 'diamond', data: { label: 'Können wir gar nichts machen?' } },
  { id: '93', type: 'option', data: { label: 'Nein :-(' } },
  { id: '94', type: 'rectangle', data: { label: 'Endspiel' } },

  { id: '95', type: 'cloud', data: { label: 'Also… können wir es richten, ohne dass ICH mich ändern muss?' } },
  ...
  { id: '104', type: 'cloud', data: { label: 'Party feiern als ob es 2099 wäre.' } },

  { id: '105', type: 'option', data: { label: 'Moment!' } },
  { id: '106', type: 'option', data: { label: 'Ja, wirklich' } },
  { id: '107', type: 'option', data: { label: 'Moment!' } },
  { id: '108', type: 'option', data: { label: 'Nö, nur noch ein Hollywood-Blockbuster' } },
  { id: '109', type: 'option', data: { label: 'Können wir den nochmal gucken?' } },
  { id: '110', type: 'diamond', data: { label: 'Ist das wirklich das Ende der Welt?' } },
  ...
  { id: '118', type: 'option', data: { label: 'Haben wir schon mal (oder so ähnlich), als wir die Ozonschicht repariert haben' } },
  { id: '119', type: 'option', data: { label: 'Ich habe 2 Kinder, 3 Jobs und einen Haufen unbezahlter Rechnungen. Kümmer DU dich!' } },

  { id: '120', type: 'diamond', data: { label: 'Müssen wir?' } },
  { id: '121', type: 'option', data: { label: 'Nö.' } },
  { id: '122', type: 'option', data: { label: 'Ja!' } },
  { id: '123', type: 'option', data: { label: 'Wir haben nicht das Recht zu fragen, ob es uns gelingen wird oder nicht…' } },
  { id: '124', type: 'quote', data: { label: '…die einzige Frage, die wir stellen dürfen: was braucht diese Erde von uns, wenn wir weiterhin auf ihr leben wollen? — Wendell Berry' } },
  ...
  { id: '130', type: 'option', data: { label: 'Die Welt hat schon andere Pläne' } },
  { id: '131', type: 'option', data: { label: 'Also, was jetzt?' } },
  { id: '132', type: 'quote', data: { label: 'Wenn es eine Bewegung gibt, haben wir eine Chance. Also lasst uns loslegen. — Bill McKibben' } },

  { id: '134', type: 'option', data: { label: 'Und ein Dilemma kann man nicht »reparieren«' } },
  { id: '135', type: 'diamond', data: { label: 'Gibt es Gründe optimistisch zu sein?' } },
  { id: '136', type: 'option', data: { label: 'Es könnte noch schlimmer sein' } },
  { id: '137', type: 'option', data: { label: 'Ja & Nein' } },
  { id: '138', type: 'quote', data: { label: 'Pessimismus des Verstandes, Optimismus des Willens. — Antonio Gramsc' } },
  { id: '139', type: 'option', data: { label: 'Okay, also...' } },
  { id: '327', type: 'option', data: { label: 'Nicht wirklich...' } },
  { id: '140', type: 'quote', data: { label: 'Ich kann kein Optimist sein, aber ich bin ein Gefangener der Hoffnung. — Desmond Tutu' } },
  ...
  { id: '144', type: 'option', data: { label: '»I Want a Better Catastrophe«' } },
  { id: '145', type: 'option', data: { label: 'Hoffnung, dein Ernst? Deine Bude brennt!' } },
  { id: '146', type: 'option', data: { label: 'Verdammt!' } },

  { id: '147', type: 'option', data: { label: 'Keine Angst…' } },
  { id: '148', type: 'option', data: { label: 'Wir stürzen nicht in einen Abgrund' } },
  { id: '149', type: 'option', data: { label: '(Puh!)' } },
  { id: '150', type: 'option', data: { label: 'Sondern nur einen schartigen, rutschigen Steilhang runter' } },
  ...
  { id: '155', type: 'quote', data: { label: 'Wir müssen das Richtige tun, weil es richtig ist. — Kathleen Dean Moore' } },

  { id: '156', type: 'option', data: { label: 'Vermächtnis' } },
  { id: '157', type: 'diamond', data: { label: 'Was für ein Vorfahre willst du sein?' } },
  { id: '158', type: 'option', data: { label: 'Ein Arschloch' } },
  { id: '159', type: 'option', data: { label: 'Mögen die Augen der Zukunft sich in dein Herz bohren' } },
  ...
  { id: '163', type: 'cloud', data: { label: 'Ich darf die Hoffnung nicht aufgeben, wenn andere sich das gar nicht leisten können.' } },
  ...
  { id: '168', type: 'cloud', data: { label: 'Ich rebelliere gegen mein Aussterben!' } },

  { id: '169', type: 'option', data: { label: 'Ich habe Kinder!' } },
  { id: '170', type: 'diamond', data: { label: 'Sollen wir in dieser Weit überhaupt noch Kinder zeugen?' } },
  { id: '171', type: 'option', data: { label: 'Ja!' } },
  { id: '172', type: 'option', data: { label: 'Ups! Habe ich schon' } },
  { id: '173', type: 'option', data: { label: 'Und sie sollen wissen, dass ich alles getan habe, was ich konnte' } },
  { id: '174', type: 'option', data: { label: 'Nein' } },

  { id: '175', type: 'option', data: { label: 'Um Zeit zu gewinnen' } },
  { id: '176', type: 'cloud', data: { label: 'Du kannst noch helfen, dass es langsamer und weniger schlimmer wird.' } },
  { id: '178', type: 'quote', data: { label: 'Zu handeln ist meine Bewältigungs- und Hoffnungs-Strategie. — Chuck Collins' } },
  { id: '179', type: 'option', data: { label: 'Vielleicht' } },
  { id: '180', type: 'option', data: { label: 'Wahrscheinlich nicht, aber…' } },
  { id: '181', type: 'cloud', data: { label: 'Die Weltgeschichte steckt voller Überraschungen. Gewissheit gibt es nicht.' } },
  
  { id: '182', type: 'diamond', data: { label: 'Warum also was tun?' } },

  { id: '183', type: 'option', data: { label: 'Kommt darauf an' } },
  { id: '184', type: 'diamond', data: { label: 'Was liebst du zu innig, um es zu verlieren?' } },
  ...
  { id: '188', type: 'option', data: { label: 'Wir müssen uns unserer Verantwortung stellen.' } },

  { id: '189', type: 'option', data: { label: 'Nun ja, okay, also…' } },
  { id: '190', type: 'cloud', data: { label: 'Der Erde geht es ohne uns besser.' } },
  { id: '191', type: 'option', data: { label: 'Das lässt sich auch anders erzählen' } },
  { id: '192', type: 'option', data: { label: 'Tatsächlich...' } },
  { id: '193', type: 'cloud', data: { label: 'Der Erde wird es gut gehen, egal, was wir machen.' } },
  { id: '194', type: 'option', data: { label: 'In zehn Millionen Jahren vielleicht' } },
  { id: '195', type: 'option', data: { label: 'Weil…' } },
  { id: '196', type: 'option', data: { label: 'Zur Hölle, nein, wird es ihr nicht!' } },
  { id: '197', type: 'cloud', data: { label: 'Wir haben ein Unheil angerichtet, das nur wir aufräumen können.' } },
  ...
  { id: '202', type: 'option', data: { label: 'Wenn nicht jetzt, wann dann?' } },
  ...
  { id: '209', type: 'cloud', data: { label: 'Die Wissenschaft findet eine Lösung.' } },
  ...
  { id: '214', type: 'quote', data: { label: 'Wir gleichen Göttern, die noch enorm viel lernen müssen. — Stewart Brand' } },
  { id: '215', type: 'option', data: { label: 'Also wirklich noch sehr, sehr viel' } },
  { id: '216', type: 'quote', data: { label: 'Kolonisieren wir nicht andere Planeten, sind wir im Arsch. — Elon Musk (sinngemäß)' } },

  { id: '217', type: 'option', data: { label: 'Energie drosseln' } },
  { id: '218', type: 'option', data: { label: 'Hä?' } },
  { id: '219', type: 'border', data: { label: 'Degrowth (Wachstumsumkehr) bezeichnet ein gerechtes Zurückfahren von Produktion und Konsum, welches das Wohl von Menschen fördert und ökologische Zustände verbessert.' } },
  { id: '220', type: 'option', data: { label: 'Oh, okay' } },

  { id: '221', type: 'option', data: { label: 'Resiliente Gemeinschaften' } },
  { id: '222', type: 'quote', data: { label: 'Wenn wir auf die Regierungen warten, wird es zu spät sein; handeln wir als Einzelne, ist das zu wenig; aber handeln wir als Gemeinschaften, könnte es vielleicht reichen. — Rob Hopkins' } },

  { id: '223', type: 'option', data: { label: 'Widerstand aus der Zivilgesellschaft' } },
  { id: '224', type: 'quote', data: { label: 'Beschützt die Heiligkeit von Mutter Erde. — Clayton Thomas Mueller' } },
  { id: '225', type: 'cloud', data: { label: 'Ich werde dieses Fleckchen Land verteidigen.' } },
  
  { id: '226', type: 'option', data: { label: 'Soziale Revolution' } },
  { id: '227', type: 'cloud', data: { label: 'Mein öko-sozialistischer Futurismus macht deinen kapitalistischen Realismus platt!' } },
  ...
  { id: '231', type: 'option', data: { label: 'Schreib mir nicht vor wie ich leben soll!' } },
  { id: '232', type: 'option', data: { label: 'Du hast die Größe des Problems noch nicht ganz begriffen…' } },
  { id: '233', type: 'cloud', data: { label: 'Warum zum Teufel recycle ich denn dann?' } },
  { id: '234', type: 'option', data: { label: 'Wegen des Trostes der Gründlichkeit?' } },
  { id: '235', type: 'option', data: { label: 'Alles und Alle' } },
  { id: '236', type: 'option', data: { label: 'Eigentlich nur ein paar Sachen…' } },

  { id: '237', type: 'option', data: { label: 'Bessere Narrative' } },
  { id: '238', type: 'cloud', data: { label: 'Suche Dir eine Metapher aus, mit der Du leben kannst.' } },
  { id: '239', type: 'option', data: { label: 'Klima- ~Wandel-Chaos-Apokalypse~ Notstand' } },
  { id: '240', type: 'option', data: { label: 'Wir sind ~Räuber~ Partner' } },
  { id: '241', type: 'option', data: { label: 'Menschheit = ~Parasiten~ Experiment' } },
  { id: '242', type: 'option', data: { label: 'Das moralische Gegenstück zum Krieg?' } },

  { id: '243', type: 'option', data: { label: 'Stärkere Gesetze' } },
  { id: '244', type: 'quote', data: { label: 'Wir haben alles Nötige, bis auf den politischen Willen. — Al Gore' } },
  { id: '245', type: 'option', data: { label: 'Emissionshandel' } },
  { id: '246', type: 'option', data: { label: 'Green New Deal' } },
  { id: '247', type: 'option', data: { label: 'Ende aller neuen Projekte zur Förderung fossiler Rohstoffe' } },
  ...
  { id: '253', type: 'option', data: { label: 'Nur noch mehr beschönigender Blödsinn' } },
  { id: '254', type: 'quote', data: { label: 'Es ist leichter sich das Ende der Welt als das Ende des Kapitalismus vorzustellen. — Slavoj Žižek' } },
  { id: '255', type: 'option', data: { label: 'Nur die gleiche alte Ungleichheits- und Ausbeutungs-Leier angetrieben von erneuerbarer Energie' } },
  { id: '256', type: 'diamond', data: { label: 'Sind das gerechte und demokratische Lösungen?' } },
  ...
  { id: '262', type: 'option', data: { label: 'Vor 30 Jahren hatten wir die' } },

  { id: '263', type: 'option', data: { label: 'Nur noch für...' } },
  { id: '264', type: 'border', data: { label: 'Geo-Engineering – vorsätzliche Eingriffe in  die Ökosysteme der Erde, wie zum Beispiel Aerosol- Injektion in die Stratosphäre.' } },
  { id: '265', type: 'option', data: { label: '»Eine schreckliche Idee, die wir vielleicht anwenden müssen«' } },

  { id: '266', type: 'options', data: { label: 'Künstler;Ingenieurin;Erzähler;Heilerin;Trickster;Philosophin;Kriegerin;Guter Nachbar' } },
  { id: '267', type: 'option', data: { label: 'Ich bin die Antenne der Menschheit' } },
  ...
  { id: '272', type: 'quote', data: { label: 'Ja, wir scheitern, aber es bleibt noch Zeit, alles zu ändern. — Greta Thunberg' } },

  { id: '273', type: 'option', data: { label: 'Blödsinn, Zeit' } },
  { id: '274', type: 'quote', data: { label: '…jetzt so zu leben, wie wir glauben, dass Menschen leben sollten, trotz all dem Übel um uns, ist für sich schon ein wunderbarer Sieg. — Howard Zinn' } },

  { id: '275', type: 'option', data: { label: 'Nö, wir haben es komplett versaut' } },
  { id: '276', type: 'quote', data: { label: 'Wenn wir die letzten unserer Art sind, warum dann nicht die besten unserer Art sein? — Guy McPherson' } },
  { id: '277', type: 'quote', data: { label: 'Bezeuge die ganze Geschichte der Menschheit mit tragischen Augen. — Jamey Hecht' } },
  { id: '278', type: 'cloud', data: { label: 'Errichtet unserem Scheitern als Gattung ein Denkmal.' } },
  ...
  { id: '283', type: 'cloud', data: { label: 'Ich suche Schönheit und Bedeutung beim Scheitern, das Unvermeidliche aufzuhalten.' } },

  { id: '284', type: 'option', data: { label: 'Mit Gewinn' } },
  { id: '285', type: 'cloud', data: { label: 'Die Apokalypse ist mein Goldesel.' } },
  ...
  { id: '289', type: 'cloud', data: { label: 'Planst du nicht für die Apokalypse, wirst du Teil des Apokalypse-Plans von jemand anderem.' } },

  { id: '290', type: 'option', data: { label: 'Unglücklich' } },
  { id: '291', type: 'cloud', data: { label: 'Aber nicht so unglücklich, dass ich meinen Mitmenschen Schlimmes antue.' } },

  { id: '292', type: 'option', data: { label: 'Ehrenvoll' } },
  { id: '293', type: 'cloud', data: { label: 'Ich werde mit erhobenem Haupt zugrunde gehen.' } },

  { id: '294', type: 'option', data: { label: 'Dankbar' } },
  { id: '295', type: 'cloud', data: { label: 'Selbst eine beschädigte Welt hält uns, schenkt uns Momente von Zauber und Freude. Ich ziehe Freude der Verzweiflung vor, denn die Erde gibt mir täglich Freude und ich sollte das Geschenk erwidern. — Robin Wall Kimmere' } },

  { id: '296', type: 'option', data: { label: 'Tragi-komisch' } },
  { id: '297', type: 'cloud', data: { label: 'Ohne Galgenhumor bleiben uns nur die Galgen.' } },

  { id: '298', type: 'option', data: { label: 'Gerecht' } },
  { id: '299', type: 'quote', data: { label: 'Wir werden leiden, also lasst uns das Leiden gerecht verteilen. — Gopal Dayaneni' } },

  { id: '328', type: 'option', data: { label: 'Kreativ' } },
  { id: '329', type: 'quote', data: { label: 'Verwandelt die neue Normalität in neue Schönheit. — John Michael Greer' } },

  { id: '330', type: 'option', data: { label: 'Resilient' } },
  { id: '331', type: 'quote', data: { label: 'Die Welt fällt auseinander, aber wir nicht. — Alejandro Frid' } },

  { id: '300', type: 'option', data: { label: 'Gemeinschaftlich' } },
  { id: '301', type: 'cloud', data: { label: 'Gemeinsam können wir es überwinden.' } },
  { id: '302', type: 'quote', data: { label: 'Vielleicht weckt die schlimmste aller Zeiten das Beste in uns. — Rebecca Solnit' } },
  { id: '303', type: 'quote', data: { label: 'Fallen, als ob wir ein Kind an unserer Brust halten. — adrienne maree brown' } },

  { id: '304', type: 'cloud', data: { label: 'Eine andere Welt (oder deren Ende) ist möglich.' } },
  { id: '305', type: 'option', data: { label: 'Alle Drei' } },
  { id: '306', type: 'diamond', data: { label: 'Worauf konzentrieren? Klimaschutz, Anpassung oder Leiden?' } },
  { id: '307', type: 'option', data: { label: 'Also...' } },
  { id: '308', type: 'quote', data: { label: 'Sei nützlich, auch wenn du nicht weißt, ob du Hebamme oder Sterbehelfer bist. — Joanna Macy' } },
  { id: '309', type: 'option', data: { label: 'Vielleicht' } },

  { id: '310', type: 'option', data: { label: 'Mutig' } },
  { id: '311', type: 'quote', data: { label: 'Wenn es zu spät ist, gibt es umso mehr, wofür es sich lohnt zu kämpfen. — Tim DeChristopher' } },
  { id: '312', type: 'option', data: { label: 'Nein, es ist mehr oder weniger viel zu spät' } },
  { id: '313', type: 'option', data: { label: 'Es ist nie zu spät!' } },

  { id: '314', type: 'option', data: { label: 'Paradox' } },
  { id: '315', type: 'quote', data: { label: 'Nachgeben ohne aufzugeben. — Meg Wheatley' } },
  { id: '316', type: 'cloud', data: { label: 'Hoffnungslosigkeit kann die Welt retten.' } },
  { id: '317', type: 'option', data: { label: 'Verzweiflung ist unsere einzige Hoffnung' } },
  ...
  { id: '325', type: 'option', data: { label: 'Du hast nichts zu verlieren, außer deines einsamen Bunkers' } },
